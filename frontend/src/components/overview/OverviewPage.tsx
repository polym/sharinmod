    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Charts Row: Model Usage and User Rankings */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Model Usage Pie Chart */}
            <Card className="clay-card border-[3px] border-indigo-100 bg-gradient-to-br from-white to-indigo-50/30">
              <CardHeader className="p-6">
                <h4 className="text-lg font-bold text-indigo-900">{t('modelUsage')}</h4>
              </CardHeader>
              <CardContent className="p-6 pt-0">
                <div className="clay-card border-2 border-indigo-200/50 rounded-2xl overflow-hidden h-48 bg-white">
                  <div className="p-4 h-full">
                    <OverviewPieChart modelUsage={overviewData.model_usage} />
                  </div>
                </div>
              </CardContent>
            </Card>
