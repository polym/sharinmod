...
interface ChangePasswordDialogContentFromMenuProps {
  onSuccess?: () => void;
}

export function ChangePasswordDialogContentFromMenu({ onSuccess }: ChangePasswordDialogContentFromMenuProps) {
